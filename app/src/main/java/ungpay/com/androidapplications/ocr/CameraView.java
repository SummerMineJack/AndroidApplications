...
public class CameraView extends FrameLayout {
    ...
    public void setMaskType(@MaskView.MaskType int maskType, final Context ctx) {
        ...
        int hintResourceId = R.mipmap.bd_ocr_hint_align_id_card;
        ...
        switch (maskType) {
            ...
            case MaskView.MASK_TYPE_BANK_CARD:
                hintResourceId = R.mipmap.bd_ocr_hint_align_bank_card;
                break;
...
//        }
        ...
        hintViewText.setPadding(SizeUtils.dp2px(10), 0,SizeUtils.dp2px(10), 0);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        int hintViewWidth = SizeUtils.dp2px(250);
        int hintViewHeight =SizeUtils.dp2px(25);

        int hintViewLeft = (getWidth() - hintViewWidth) / 2;
        int hintViewTop = maskView.getFrameRect().bottom + SizeUtils.dp2px(16);
