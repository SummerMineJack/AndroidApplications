...
public class MaskView extends View {
    ...
    public static final int MASK_TYPE_DRIVING_LICENSE_FRONT = 3;
    public static final int MASK_TYPE_DRIVING_LICENSE_BACK = 4;
    ...
    @IntDef({MASK_TYPE_NONE, MASK_TYPE_ID_CARD_FRONT, MASK_TYPE_ID_CARD_BACK, MASK_TYPE_BANK_CARD,
            MASK_TYPE_PASSPORT, MASK_TYPE_DRIVING_LICENSE_FRONT, MASK_TYPE_DRIVING_LICENSE_BACK})
    @interface MaskType {
    ...
    public void setMaskType(@MaskType int maskType) {
        ...
        switch (maskType) {
            case MASK_TYPE_ID_CARD_FRONT:
                locatorDrawable = ResourcesCompat.getDrawable(getResources(), R.mipmap.bd_ocr_id_card_locator_front, null);
                break;
            case MASK_TYPE_ID_CARD_BACK:
                locatorDrawable = ResourcesCompat.getDrawable(getResources(), R.mipmap.bd_ocr_id_card_locator_back, null);
                break;
            case MASK_TYPE_PASSPORT:
                locatorDrawable = ResourcesCompat.getDrawable(getResources(), R.mipmap.bd_ocr_passport_locator, null);
                break;
            case MASK_TYPE_DRIVING_LICENSE_FRONT:

                break;
            case MASK_TYPE_DRIVING_LICENSE_BACK:
                break;
