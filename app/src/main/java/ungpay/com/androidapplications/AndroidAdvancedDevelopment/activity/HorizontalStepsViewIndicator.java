...
public class HorizontalStepsViewIndicator extends View
{
    ...
    private void init()
    {
        ...
        mCompleteIcon = ContextCompat.getDrawable(getContext(), R.drawable.ic_launcher_background);//已经完成的icon
        mAttentionIcon = ContextCompat.getDrawable(getContext(), R.drawable.ic_launcher_background);//正在进行的icon
        mDefaultIcon = ContextCompat.getDrawable(getContext(), R.drawable.ic_launcher_background);//未完成的icon
    }
